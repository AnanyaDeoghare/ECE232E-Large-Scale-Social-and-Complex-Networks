...
6. Launch Jupyter Lab from terminal and run the notebook titled "ece232e_project4_stock.ipynb". Go through all the sections sequentially.
...
4. Open the notebooks "Project4_Ananya.ipynb"[Q9-Q13], "Q14_18.ipynb", "Project4_Strategies.ipynb"[Q19-Q22] and just sequentially run all the sections.
